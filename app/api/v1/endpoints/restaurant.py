...
@router.get('/home', response_model=MobileHomeResponse, tags=['Restaurant Home'])
...
async def list_insights(current_user: dict = Depends(get_current_user), service: MobileOperationsService = Depends(get_mobile_operations_service)) -> InsightDetailResponse:
...
@router.get('/settings/profile', response_model=MobileProfileResponse, tags=['Restaurant Settings'])
...
@router.put('/settings/profile', response_model=MobileProfileResponse, tags=['Restaurant Settings'])

...
def test_auth_restaurant_register_verify_login_and_me(client, owner_credentials):
    ...
    assert verified_user['subscription_plan'] is None
    assert verified_user['subscription_started_at'] is None
    assert verified_user['subscription_expires_at'] is None
    ...
    assert me_response.json()['subscription_status'] is None

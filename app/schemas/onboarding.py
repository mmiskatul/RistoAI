...
class OnboardingProfileUpsertRequest(BaseSchema):
    ...
    restaurant_type: str = Field(min_length=2, max_length=60)
    city_location: str = Field(min_length=2, max_length=120)
    ...
    main_business_goal: str = Field(min_length=2, max_length=120)
    biggest_problem: str = Field(min_length=10, max_length=1000)
    improvement_focus: str = Field(min_length=5, max_length=1000)
